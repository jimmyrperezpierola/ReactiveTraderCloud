          ...
          <SectionBlock mh={0} py={0}>
            <Paragraph>
              <i>
                ...
                application by selecting a few base colors to work from. The collection below is
                setup in such a way that it will generate the varying color scales for you. From
                this spectrum you should color pick and define the final color values to be used in
                your user interface.
              </i>
            </Paragraph>
          </SectionBlock>
